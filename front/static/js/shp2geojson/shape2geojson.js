...
(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        1: [function(require, module, exports) {
            module.exports.loadshp = require('./loadshp');
        }, { "./loadshp": 2 }],
        2: [function(require, module, exports) {
            (function() {
                dojo.require("/shp2geojson/lib/proj4");
                dojo.require("/static/js/shp2geojson/lib/jszip");
                dojo.require("/static/js/shp2geojson/lib/jszip-utils");
                dojo.require("/static/js/shp2geojson/lib/shapparser");
            })();
            var proj4 = require("/shp2geojson/lib/proj4"),
                JSZip = require("/static/js/shp2geojson/lib/jszip"),
                Jszip_utils = require("/static/js/shp2geojson/lib/jszip-utils"),
                Shapparser = require("/static/js/shp2geojson/lib/shapparser");
            var inputData = {},
                geoData = {},
                EPSGUser, url, encoding, EPSG,
                EPSG4326 = null; //proj4('EPSG:4326');
                ...
                for (var i = 0; i < shpRecords.length; i++) {
                    ...
                    switch (shpRecords[i].shape.type) {
                        case 1:
                            ...
                            break;
                        case 3:
                            geometry.type = shpRecords[i].shape.content.parts.length <= 1 ? "LineString" : "MultiLineString";
                            geometry.coordinates = [];
